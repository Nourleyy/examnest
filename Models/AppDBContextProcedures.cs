...
namespace ExamNest.Models
{
    ...
    public partial class AppDBContextProcedures : IAppDBContextProcedures
    {
        ...
        public virtual async Task<int> AddUserAsync(string name, string email, string password_hash, string provider, string provider_id, string role, int? student_id, int? instructor_id, bool? is_admin, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var sqlParameters = new []
            {
                ...
                new SqlParameter
                {
                    ...
                    Size = 255,
                    Value = password_hash ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.VarChar,
                },
                new SqlParameter
                {
                ...
                new SqlParameter
                {
                    ...
                    Size = 255,
                    Value = provider_id ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.VarChar,
                },
                new SqlParameter
                {
                ...
                new SqlParameter
                {
                    ParameterName = "is_admin",
                    Value = is_admin ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Bit,
                },
                parameterreturnValue,
            };
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [Auth].[AddUser] @name = @name, @email = @email, @password_hash = @password_hash, @provider = @provider, @provider_id = @provider_id, @role = @role, @student_id = @student_id, @instructor_id = @instructor_id, @is_admin = @is_admin", sqlParameters, cancellationToken);
        ...
        public virtual async Task<int> AssignPermissionToRoleAsync(int? role_id, int? permission_id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var sqlParameters = new []
            {
                ...
                new SqlParameter
                {
                    ParameterName = "permission_id",
                    Value = permission_id ?? Convert.DBNull,
                    SqlDbType = System.Data.SqlDbType.Int,
                },
                parameterreturnValue,
            };
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [Auth].[AssignPermissionToRole] @role_id = @role_id, @permission_id = @permission_id", sqlParameters, cancellationToken);
        ...
        public virtual async Task<int> AssignRoleToUserAsync(int? user_id, int? role_id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [Auth].[AssignRoleToUser] @user_id = @user_id, @role_id = @role_id", sqlParameters, cancellationToken);
        ...
        public virtual async Task<List<AuthenticateUserResult>> AuthenticateUserAsync(string email, string password_hash, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<AuthenticateUserResult>("EXEC @returnValue = [Auth].[AuthenticateUser] @email = @email, @password_hash = @password_hash", sqlParameters, cancellationToken);
